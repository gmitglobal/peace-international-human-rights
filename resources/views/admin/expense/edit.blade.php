...
@section('content')
    <div class="container-fluid">
        <div class="row mb-3">
            <div class="col-lg-12">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.expense.index') }}">
                    <i class="fa fa-arrow-left"></i> Back to Expense List
                </a>
            </div>
        </div>
        <hr>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-success text-white">
                        <h5 class="mb-0 text-white"><i class="fas fa-folder-plus me-2"></i> Edit Expense</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.expense.update', $expense->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control form-control-sm"
                                    placeholder="Enter Title" value="{{ old('title', $expense->title) }}">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-sm" name="description" id="description" cols="30" rows="4"
                                    placeholder="Write the post">{{ old('description', $expense->description) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-3">
                                    <img id="file-ip-1-preview"
                                        src="{{ $expense->post_image ? asset($expense->post_image) : asset('no_image.jpg') }}"
