...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row mb-3">
            <div class="col-lg-12">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.activities.index') }}">
                    <i class="fa fa-arrow-left"></i> Back to Activities List
                </a>
            </div>
        </div>
        <hr>
            ...
            <div class="col-lg-8 col-md-10">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0 text-white"><i class="fas fa-folder-plus me-2"></i> Add Activities</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.activities.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control form-control-sm" name="paragraph" id="paragraph" cols="30" rows="4"
                                    placeholder="Write the post">{{ old('paragraph') }}</textarea>
                            </div>
