                        ...
                        <form action="{{ route('admin.video.gallery.update', $videoGallery->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control form-control-sm"
                                    placeholder="Enter Title" value="{{ old('title', $videoGallery->title) }}">
                            </div>

                            <!-- Paragraph -->
                            <div class="mb-3">
                                <label for="paragraph" class="form-label">Video Link</label>
                                <input type="text" name="paragraph" id="paragraph" class="form-control form-control-sm"
                                    placeholder="Video Link" value="{{ old('title', $videoGallery->video_link) }}">
                                {{-- <textarea class="form-control form-control-sm" name="paragraph" id="paragraph" cols="30" rows="4"
                                    placeholder="Video Link">{{ old('paragraph', $videoGallery->video_link) }}</textarea> --}}
                            </div>
