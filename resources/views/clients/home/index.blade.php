                    ...
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}"
                        ...
                        <div class="carousel-caption d-flex flex-column justify-content-center align-items-center">
                            ...
                            <h1 class="fw-bold text-warning mb-3 animate__animated animate__fadeInDown">
                                {{ $slider->title ?? 'Promoting Global Peace & Human Rights' }}
                            </h1>

                            <p class="lead text-white mb-4 animate__animated animate__fadeInUp">
                                {{ $slider->subtitle ?? 'Empowering communities through advocacy, education, and compassion.' }}
                            </p>

                            <div class="d-flex justify-content-center gap-3">
                                @if (!empty($slider->primary_button_text) && !empty($slider->primary_button_link))
                                    <a href="{{ $slider->primary_button_link }}" class="btn btn-primary btn-lg">
                                ...
                                @if (!empty($slider->secondary_button_text) && !empty($slider->secondary_button_link))
                                    <a href="{{ $slider->secondary_button_link }}"
                                        class="text-white btn btn-outline-brand btn-lg">
